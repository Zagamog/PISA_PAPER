...
\subsection{Student attitudes towards mathematics}
...
\begin{table}[H]
	...
	\def\arraystretch{0.9}
	\centering
	\caption{\textbf{Summary statistics - teacher characteristics and quantitative measures}}
	\begin{tabulary}{1.0\textwidth}{L L C C C C}
		\hline\hline \\
		\multicolumn{2}{c}{}
		& \multicolumn{2}{c}{Dev7 countries}
...
\begin{table}[H]
	...
	\def\arraystretch{0.9}
	\centering
	\caption{\textbf{Summary statistics - pedagogical/teaching practices}}
	\begin{tabulary}{1.0\textwidth}{L L C C C C}
		\hline\hline \\
		\multicolumn{2}{c}{}
		& \multicolumn{2}{c}{Dev7 countries}
...
\begin{table}[H]
	...
	\def\arraystretch{0.9}
	\centering
	\caption{\textbf{Summary statistics - school characteristics}}
	\begin{tabulary}{1.0\textwidth}{L L C C C C}
		\hline\hline \\
		\multicolumn{2}{c}{}
		& \multicolumn{2}{c}{Dev7 countries}
...
\begin{table}[H]
	...
	\def\arraystretch{0.9}
	\centering
	\caption{\textbf{Summary statistics - school resources}}
	\begin{tabulary}{1.0\textwidth}{L L C C C C}
		\hline\hline \\
		\multicolumn{2}{c}{}
		& \multicolumn{2}{c}{Dev7 countries}
...
\begin{table}[H]
	...
	\def\arraystretch{0.9}
	\centering
	\caption{\textbf{Summary statistics - school leadership}}
	\begin{tabulary}{1.0\textwidth}{L L C C C C}
		\hline\hline \\
		\multicolumn{2}{c}{}
		& \multicolumn{2}{c}{Dev7 countries}
...
\begin{table}[H]
	...
	\def\arraystretch{0.9}
	\centering
	\caption{\textbf{Summary statistics - school climate}}
	\begin{tabulary}{1.0\textwidth}{L L C C C C}
		\hline\hline \\
		\multicolumn{2}{c}{}
		& \multicolumn{2}{c}{Dev7 countries}
...
\subsection{The estimated impact of 'Vietnam' on Mathematics PISA test scores}
	\begin{table}[H]
		...
		\def\tabcolsep{4}
		\centering
		\caption{\textbf{The estimated impact of 'Vietnam' on Mathematics PISA test scores}}
...
\subsection{The estimated impact of 'Vietnam' on Reading PISA test scores}
	...
	\begin{table}[H]
		...
		\def\tabcolsep{4}
		\centering
		\caption{\textbf{The estimated impact of 'Vietnam' on Reading PISA test scores}}
		\begin{tabular}{lrlrlrlrlrlrlrl}
			\toprule
			\midrule
...
\subsection{The estimated impact of 'Vietnam' on Science PISA test scores}
	...
	\begin{table}[H]
		...
		\def\tabcolsep{4}
		\centering
		\caption{\textbf{The estimated impact of 'Vietnam' on Science PISA test scores}}
		\begin{tabular}{lrlrlrlrlrlrlrl}
			\toprule
			\midrule
